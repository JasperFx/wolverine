...
namespace Internal.Generated.WolverineHandlers
{
    ...
    public sealed class GET_querystring_collection_enum : Wolverine.Http.HttpHandler
    {
        ...
        public override async System.Threading.Tasks.Task Handle(Microsoft.AspNetCore.Http.HttpContext httpContext)
        {
            ...
            {
                if (WolverineWebApi.Direction.TryParse<WolverineWebApi.Direction>(collectionValue, true, out var collectionValueParsed))
                {
