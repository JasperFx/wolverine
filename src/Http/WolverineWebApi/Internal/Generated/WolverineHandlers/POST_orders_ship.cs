...
namespace Internal.Generated.WolverineHandlers
{
    ...
    public class POST_orders_ship : Wolverine.Http.HttpHandler
    {
        ...
        public POST_orders_ship(Wolverine.Http.WolverineHttpOptions options, Wolverine.Marten.Publishing.OutboxedSessionFactory outboxedSessionFactory, Wolverine.Runtime.IWolverineRuntime wolverineRuntime) : base(options)
        {
            _options = options;
