...
namespace Internal.Generated.WolverineHandlers
{
    ...
    public class POST_validate2_user : Wolverine.Http.HttpHandler
    {
        ...
        private readonly FluentValidation.IValidator<Wolverine.Http.Tests.DifferentAssembly.Validation.CreateUser2> _validator_of_CreateUser21660690938;
        ...
        private readonly FluentValidation.IValidator<Wolverine.Http.Tests.DifferentAssembly.Validation.CreateUser2> _validator_of_CreateUser21145170864;

        public POST_validate2_user(Wolverine.Http.WolverineHttpOptions wolverineHttpOptions, [Lamar.Named("createUserValidator")] FluentValidation.IValidator<Wolverine.Http.Tests.DifferentAssembly.Validation.CreateUser2> validator_of_CreateUser21660690938, Wolverine.Http.FluentValidation.IProblemDetailSource<Wolverine.Http.Tests.DifferentAssembly.Validation.CreateUser2> problemDetailSource, [Lamar.Named("passwordValidator")] FluentValidation.IValidator<Wolverine.Http.Tests.DifferentAssembly.Validation.CreateUser2> validator_of_CreateUser21145170864) : base(wolverineHttpOptions)
        {
            _wolverineHttpOptions = wolverineHttpOptions;
            _validator_of_CreateUser21660690938 = validator_of_CreateUser21660690938;
            _problemDetailSource = problemDetailSource;
            _validator_of_CreateUser21145170864 = validator_of_CreateUser21145170864;
        }
        ...
        {
            var validatorList = new System.Collections.Generic.List<FluentValidation.IValidator<Wolverine.Http.Tests.DifferentAssembly.Validation.CreateUser2>>{_validator_of_CreateUser21660690938, _validator_of_CreateUser21145170864};
