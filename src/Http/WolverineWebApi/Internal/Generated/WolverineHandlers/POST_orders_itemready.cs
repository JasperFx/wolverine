...
namespace Internal.Generated.WolverineHandlers
{
    ...
    public class POST_orders_itemready : Wolverine.Http.HttpHandler
    {
        ...
        public override async System.Threading.Tasks.Task Handle(Microsoft.AspNetCore.Http.HttpContext httpContext)
        {
            ...
            var eventStream = await eventStore.FetchForWriting<WolverineWebApi.Marten.Order>(aggregateId, command.Version, httpContext.RequestAborted).ConfigureAwait(false);
