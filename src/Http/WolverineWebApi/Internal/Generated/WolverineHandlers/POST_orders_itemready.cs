...
namespace Internal.Generated.WolverineHandlers
{
    ...
    public sealed class POST_orders_itemready : Wolverine.Http.HttpHandler
    {
        ...
        public override async System.Threading.Tasks.Task Handle(Microsoft.AspNetCore.Http.HttpContext httpContext)
        {
            ...
            var eventStream = await eventStoreOperations.FetchForWriting<WolverineWebApi.Marten.Order>(aggregateId, command.Version, httpContext.RequestAborted).ConfigureAwait(false);

            string expectedVersion_rawValue = httpContext.Request.Query["expectedVersion"];
            long expectedVersion = default;

            if (expectedVersion_rawValue != null && long.TryParse(expectedVersion_rawValue, System.Globalization.CultureInfo.InvariantCulture, out expectedVersion))
            {
