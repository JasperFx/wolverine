...
namespace Internal.Generated.WolverineHandlers
{
    ...
    public sealed class GET_api_myapp_registration_price : Wolverine.Http.HttpHandler
    {
        ...
        {
            string numberOfMembers_rawValue = httpContext.Request.Query["numberOfMembers"];
            int numberOfMembers = default;

            if (numberOfMembers_rawValue != null && int.TryParse(numberOfMembers_rawValue, System.Globalization.CultureInfo.InvariantCulture, out numberOfMembers))
            {
