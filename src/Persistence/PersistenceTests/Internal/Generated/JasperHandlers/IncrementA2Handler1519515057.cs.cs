...
namespace Internal.Generated.WolverineHandlers
{
    ...
    public class IncrementA2Handler1519515057 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public IncrementA2Handler1519515057(Wolverine.Marten.Publishing.OutboxedSessionFactory outboxedSessionFactory, Microsoft.Extensions.Logging.ILogger<Wolverine.Persistence.Testing.Marten.SelfLetteredAggregate> logger)
        {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.IMessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            if (eventStream.Aggregate == null) throw new Wolverine.Marten.UnknownAggregateException(typeof(Wolverine.Persistence.Testing.Marten.SelfLetteredAggregate), incrementA2.SelfLetteredAggregateId);
