...
public static class WolverineOptionsFisherExtensions
{
        ...
        Action<FisherIntegration>? configure = null)
    {
        ...
        // Fisher sessions. When a handler falls back to service location, the generated code primes the
    ...
    // outside a handler scope -- where PreferPrimedSession falls back to Fisher's own session factory.
