...
/// <summary>
///     Marks a parameter to a Wolverine HTTP endpoint or message handler method as being part of the Fisher event sourcing
///     "aggregate handler" workflow
/// </summary>
/// <remarks>
///     GH-3907: the workflow itself is <see cref="WriteModelAttribute" /> in Wolverine core now, and works
///     the same against any event store integration. This is the Fisher spelling of it, kept because it is
...
public class WriteAggregateAttribute : WriteModelAttribute
{
    ...
    ///     <see cref="Wolverine.Fisher.ConcurrencyStyle" /> keeps compiling. The two enums are the same two
