...
///     "command" messages that use a Fisher projected aggregate to "decide" what
...
///     works the same against any event store integration. This is the Fisher spelling of it, kept because
...
public class AggregateHandlerAttribute : DeciderFunctionAttribute
{
    ...
    // that [AggregateHandler(ConcurrencyStyle.Exclusive)] written against Wolverine.Fisher's spelling
    // keeps compiling.
