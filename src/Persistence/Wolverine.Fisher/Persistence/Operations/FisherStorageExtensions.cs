...
internal static class FisherStorageExtensions
{
    public static void StoreIncoming(this IDocumentSession session, SqliteMessageStore store, Envelope envelope)
    {
    ...
    public static void StoreOutgoing(this IDocumentSession session, SqliteMessageStore store, Envelope envelope,
        int ownerId)
    {
