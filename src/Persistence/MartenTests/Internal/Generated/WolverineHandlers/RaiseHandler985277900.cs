...
namespace Internal.Generated.WolverineHandlers
{
    ...
    public class RaiseHandler985277900 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var raise = (Raise)context.Envelope.Message;
            ...
            (var outgoing1, var outgoing2) = RaiseLetterHandler.Handle(raise, eventStream.Aggregate);
            ...
            var response_of_letterAggregate = await eventStore.FetchLatest<LetterAggregate>(aggregateId, cancellation);
