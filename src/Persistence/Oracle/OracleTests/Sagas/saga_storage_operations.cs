...
public class saga_storage_operations
{
    ...
    public async Task load_with_no_document_happily_returns_null()
    {
        ...
        using var tx = (OracleTransaction)await conn.BeginTransactionAsync(TestContext.Current.CancellationToken);
    ...
    public async Task insert_then_load()
    {
        ...
        var db2 = (OracleTransaction)await conn.BeginTransactionAsync(TestContext.Current.CancellationToken);
    ...
    public async Task concurrency_exception_when_version_does_not_match()
    {
        ...
        db = (OracleTransaction)await conn.BeginTransactionAsync(TestContext.Current.CancellationToken);
